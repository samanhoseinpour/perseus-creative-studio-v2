...
The most common cause is friction between your visitor and the action you want them to take. Marketing brings people to the door, but hidden phone numbers, over-complicated menus, and massive contact forms trigger decision fatigue, and the brain takes the path of least resistance: it leaves. Design a clear "Golden Path" with an always-visible call-to-action and ask for just an email or phone number first.

### Do stock photos really hurt a small business website?

Yes. Generic stock photography creates a "Visual Trust Gap" between what you claim and what you can prove, and it breeds skepticism in a local market. Vancouver customers respond to real faces, real projects, and recognizable local environments, so authentic brand photography and video consistently outperform filler imagery.

### How important is mobile design for a Vancouver business?

It is essential: over 65% of local searches in British Columbia happen on a mobile device, and Google uses mobile-first indexing to decide your rankings. A slow or clunky mobile site drops your visibility, raises bounce rates, and wastes any ad budget pointing at it. Design for the thumb zone, vertical media, and fast load times first.

### How often should I update my website?

Your website needs a regular pulse, not a weekly essay. Adding recent projects to your portfolio, replacing dated photos with current media, and posting occasional local-market updates all signal to both customers and Google that your business is active. A site that has not changed in years triggers "Abandoned Shop" syndrome and slowly loses rankings to competitors who publish fresh content.

### What does it cost to fix an underperforming website?

It depends entirely on scope: some sites need targeted fixes like clearer calls-to-action and faster mobile load times, while others need a full redesign around authentic media and local SEO. The right starting point is an audit of where your site is actually leaking sales. The Perseus team reviews your site and maps out the fixes in a consultation.
