...
export const ADMIN_HELP: Record<AdminHelpKey, AdminHelpTopic> = {
  ...
  tasks: {
    ...
    sections: [
      ...
      'On the "Done" tab and in the Digest there is a month picker in the header, the same one Reports has. Pick a month to read just that month; pick "All time" (or "Last 7 days" in the Digest) to go back. The other tabs have no month picker on purpose, because work still in flight should never be hidden behind one.',
