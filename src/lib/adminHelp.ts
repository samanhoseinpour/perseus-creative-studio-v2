...
export const ADMIN_HELP: Record<AdminHelpKey, AdminHelpTopic> = {
  ...
  profile: {
    ...
    tips: [
      ...
      'When a notification arrives, the dashboard\u2019s app icon also picks up a small count \u2014 on your Dock, taskbar or Home Screen \u2014 so you can see something is waiting without unlocking anything. It clears the moment you open the dashboard.',
