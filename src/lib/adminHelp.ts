    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          '"Delivered": the finished work is in the client\'s hands.',
          '"Posted": it is live on the client\'s channels.',
          'Done, Delivered and Posted all count exactly the same. Moving a task along never changes the numbers and never moves it to a different month, so you can keep a task up to date without worrying about a report you already sent.',
          'A task that has shipped keeps showing its dates, and adds the day it was finished on a small line underneath. Click that day to change it. Useful when work was logged late. If the new day is in another month the picker says so, because the task moves to that month\'s report.',
          'Only Done asks for that day. Once a task has it, Delivered and Posted keep the same day rather than asking again, which is what stops a task drifting into the month you happened to hand it over in.',
        ],
      },
    ],
    tips: [
      ...
      'Swipe a card left to delete it, or right to move it one step along: to Done, then Delivered, then Posted. Both ask before anything happens, and the window is the same one you get on a computer. A posted task doesn’t swipe right, because there is nowhere further to go, and nothing ever swipes backwards; reopening lives in the ⋯ menu, because it would move the task out of a month you may already have reported.',
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          '"Print report" opens the A4 sheet. Use your browser\'s Save as PDF. "CSV" downloads the raw month, one row per task with a "stage" and a "revision" column, so it is where to look when you need the rounds listed separately.',
        ],
      },
    ],
    tips: [
