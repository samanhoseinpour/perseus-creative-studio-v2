...
export const ADMIN_HELP: Record<AdminHelpKey, AdminHelpTopic> = {
  ...
  tasks: {
    ...
    tips: [
      ...
      'To pick several on a phone, tap the checkbox on a card or press and hold it. Once anything is picked, tapping a card selects it instead of opening it, and the bar above the list acts on all of them — “More” there holds the rest of the controls.',
