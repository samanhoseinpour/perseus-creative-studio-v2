...
export const ADMIN_HELP: Record<AdminHelpKey, AdminHelpTopic> = {
  ...
  profile: {
    ...
    tips: [
      ...
      'A password reset ends every signed-in session but does NOT remove passkeys. If you are resetting because you think someone else had access, wait a few minutes and then check this list — a device that was already open takes that long to lose its hold, and a passkey added in the meantime would outlast the reset.',
