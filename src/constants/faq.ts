...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Social strategy, day-to-day management, influencer and creator collaborations, and reporting & insights. Content is produced in-house by the same production team, so the feed is original photo and video cut for each platform, not stock and not reposts.',
  ...
  },
  {
    ...
    answer:
      'Brand strategy & positioning, logo and visual identity, brand messaging & copywriting, brand guidelines, and creative direction. Identities ship as systems with usage rules your future designers, printers, and developers can follow, rather than as a single logo file.',
  ...
  },
  {
    ...
    answer:
      'Tell us anyway. If it’s adjacent, whether that’s a print piece that has to match the identity, a platform we haven’t run before, or a tool we haven’t integrated, we’ll usually scope it. If it’s genuinely outside what we do well, we’ll say so on the first call and point you somewhere better rather than stretching a scope to fit.',
  },
  ...
  },
  {
    ...
    answer:
      'Our Google Business Profile reviews are pulled live onto the home and About pages, and the client wall on About shows who we’ve worked with. For references matched to your industry and the exact deliverable you’re weighing, just ask, and we’ll connect you with the most relevant one rather than a generic testimonial.',
    links: [
  ...
  },
  {
    ...
    answer:
      'The blog carries what we’ve learned from live client work across websites, SEO, paid media, production, and social, written or reviewed by the team and attributed to named authors rather than a generic byline. The blog index has its own FAQ covering cadence, sourcing, and how to quote or republish a piece.',
    links: [
  ...
  },
  {
    ...
    answer:
      'Because a case study written on launch day isn’t worth your time. We publish the full write-up once there’s something real to report, whether that is measured performance for a site, a matured results window for a campaign, or an identity actually live in the world. Until then the archive card carries the scope, the client, and the work itself.',
  },
  {
    category: 'Projects',
    question: 'Can I see work for my specific industry?',
    answer:
      'Filter any category by industry. Real estate, construction & trades, hospitality & events, sports & fitness, health & wellness, retail & e-commerce, home services, boats & yachts, and energy & infrastructure are all represented. If your niche isn’t listed, ask and we’ll send the closest relevant references and explain the strategy, deliverables, and production approach behind them.',
    links: [
  ...
  },
  {
    ...
    answer:
      'Sitemap and page structure, UX flows, visual design with a reusable component system, developed and mobile-optimized pages, SEO foundations, analytics and conversion tracking, a launch checklist, and a documented handover. Integrations such as forms, CRM and email workflows, booking, and payments are scoped in when the project needs them.',
  ...
  },
  {
    ...
    answer:
      'Often, yes. We regularly plug into an in-house marketing lead, an existing developer, or another agency running a channel we don’t. We define the seams up front, covering who owns what, where access sits, and how handoffs happen, so nothing falls into the gap between two teams.',
  },
  {
    category: 'Process',
  ...
  },
  {
    ...
    answer:
      'Everything published here, from photography and video to design, code, and copy, is owned by Perseus or licensed to us, and isn’t free to reuse. The License page sets out exactly what’s permitted, what isn’t, and how to request permission; the Terms of Service cover everything else about using the site.',
    links: [
  ...
  },
  {
    ...
    answer:
      'As a loop, not a project. Define the conversions that matter, confirm the tracking is honest, then read real behaviour across traffic sources, drop-off points, click paths, and form performance to find where conversions leak. We prioritize the highest-impact fixes (copy, layout, UX, speed, CTAs, funnel steps) and measure each one against the outcome instead of a vanity metric.',
    links: [
      {
  ...
  },
  {
    ...
    answer:
      'By reducing decision friction. Good video and photography show proof of the work, the space, the process, and the people faster than any paragraph can, and they hold attention long enough for someone to act. Placed at the hero, the key service explanation, testimonials, and beside the call to action, they carry visitors through the decision. We also optimize delivery so they don’t cost you load speed.',
    links: [{ label: 'Production services', href: '/services/production' }],
  },
  ...
  },
  {
    ...
    answer:
      'Through a shared, tracked system rather than scattered emails, so the status of every request is visible. Urgent issues such as downtime, a security problem, or a broken form are prioritized immediately; routine edits and updates are scheduled and delivered within the turnaround agreed for your engagement.',
  },
  {
    category: 'Support',
  ...
  },
  {
    ...
    answer:
      'Yes, with dedicated URLs per language or region, hreflang implementation, translated page content, localized SEO metadata, and region-appropriate policy language where it’s required. We also agree the update workflow up front, so the versions don’t quietly drift apart six months after launch.',
  },
  {
    category: 'Industries',
