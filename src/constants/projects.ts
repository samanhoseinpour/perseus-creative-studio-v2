...
export const PROJECT_CATEGORIES: Record<string, ProjectCategoryContent> = {
  ...
  'digital-marketing': {
    ...
    cta: {
      ...
      description:
        'The digital marketing service page covers the levers we pull, from SEO to paid channels to tracking, and what a measured engagement looks like.',
      primaryLabel: 'Start a Project',
      primaryHref: '/contact',
  ...
  social: {
    ...
    comingSoon: {
      ...
      body: 'Social case studies are written up across a full engagement arc of strategy, cadence, and growth, not a single viral week. Current programs are still accumulating their numbers.',
      inProduction: [
    ...
    cta: {
      ...
      description:
        'The social media service page covers how we plan, produce, and report, from strategy through posting cadence.',
      primaryLabel: 'Start a Project',
      primaryHref: '/contact',
    ...
    faqs: [
      {
        ...
        answer:
          'Strategy, a content calendar, the creative (shot with the production team when needed), posting cadence, and reporting on growth, managed as a program across a full engagement rather than a one-off burst.',
      },
      {
        question: 'Why don’t these programs have full write-ups yet?',
        answer:
          'The accounts we manage are listed here; the written case studies come later. Social work is only worth writing up across a full engagement arc of strategy, cadence, and growth, rather than a single viral week, so current programs are still accumulating their numbers.',
      },
      {
  ...
  branding: {
    ...
    comingSoon: {
      ...
      body: 'Branding case studies publish when the identity is live in the world, with signage up, the site shipped, and the voice in use. Current engagements are in the design phase.',
      inProduction: [
    ...
    cta: {
      ...
      description:
        'The branding service page covers the full system of strategy, identity, messaging, and the guidelines that keep it coherent.',
      primaryLabel: 'Start a Project',
      primaryHref: '/contact',
    ...
    faqs: [
      {
        ...
        answer:
          'Brand strategy, the identity system (logo, type, color, and usage), and the core applications that carry it, delivered as a system your team and ours can build on rather than a single logo file.',
      },
      {
        question: 'Why don’t these identities have full write-ups yet?',
        answer:
          'The engagements are listed here as delivered artifacts; the written case study publishes once the identity is fully live in the world, with signage up, the site shipped, and the voice in use. Several current engagements are still in that rollout phase.',
      },
      {
