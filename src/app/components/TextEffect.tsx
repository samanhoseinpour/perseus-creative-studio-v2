...
const createVariantsWithTransition = (
  ...
  // Pull out optional `exit` overrides without creating an unused var
    ...
    exit: {
      ...
      transition: {
        ...(hasTransition(baseVariants.exit)
          ...
          : {}),
        ...mainTransition,
        ...(exit ?? {}), // allow per-exit overrides if provided
        staggerDirection: -1, // ensure reverse order on exit
      },
    },
  };
};
