...
const HeroSection = () => {
  return (
    <>
      <div className="overflow-hidden pb-12 bg-background">
        <div className="pt-24 md:pt-36">
          <Container>
            <div className="mt-12 gap-4 sm:grid sm:grid-cols-2">
              ...
              <div className="mt-6 sm:mt-0 text-white/70 text-sm font-semibold">
                ...
                <p className="mt-3">
                  ...
                  milestones, rapid feedback cycles, and measurable outcomes—so
                  you ship faster and scale confidently.
                </p>
            ...
            <div className="mask-b-from-45% bg-background relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
              <YoutubePlayer
                videoId="T8FWp9bSkq4"
