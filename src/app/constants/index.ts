...
export const youtubeEmbedIdsFirstRow = [
...
export const youtubeEmbedIdsSecondRow = [
...
export const mainProductionData = [
  ...
  {
    id: 4,
    imageSrc: "/services-content-creation.jpg",
    tag: "Content Creation",
    title: "Content Creation Services",
    description: "Engaging content creation for your brand.",
  },
];
