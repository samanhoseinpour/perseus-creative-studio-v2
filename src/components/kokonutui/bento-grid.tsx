...
const TimelineFeature = ({
  ...
  <div className="relative mt-3">
    ...
    {timeline.map((item) => (
      ...
      >
        <div className="z-10 mt-0.5 h-5 w-5 shrink-0 rounded-full border-2 border-neutral-300 bg-neutral-100 dark:border-neutral-600 dark:bg-neutral-800" />
        <div>
        ...
        >
          <div className="flex flex-1 flex-col space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="font-semibold text-neutral-900 text-xl leading-xl transition-colors duration-300 group-hover:text-neutral-700 dark:text-neutral-100 dark:group-hover:text-neutral-300">
                {item.title}
              </h3>
            ...
            <p className="text-black/70 text-sm leading-sm dark:text-neutral-400">
              {item.description}
            </p>
...
export default function BentoGrid() {
  return (
    <section className="relative overflow-hidden section-padding dark:bg-black">
      <Container>
        {/* Bento Grid */}
        <div className="grid gap-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="overflow-hidden rounded-xl border border-neutral-200/50 bg-linear-to-b from-neutral-50/80 to-neutral-50 transition-all duration-300 hover:border-neutral-400/30 hover:shadow-lg hover:shadow-neutral-200/20 md:col-span-1 dark:border-neutral-800/50 dark:from-neutral-900/80 dark:to-neutral-900 dark:hover:border-neutral-600/30 dark:hover:shadow-neutral-900/20">
              <div className="p-5">
                <div className="mb-2 flex items-center justify-between">
                  <h3 className="font-semibold text-neutral-900 text-xl leading-xl dark:text-neutral-100">
                    Chat Bot
                  </h3>
                </div>
                <p className="mb-4 text-neutral-600 text-sm leading-sm  dark:text-neutral-400">
                  We can build a chatbot for your website that acts as a support
                  layer—answering questions, guiding users, and handing off to
