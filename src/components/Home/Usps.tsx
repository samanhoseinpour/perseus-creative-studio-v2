...
const Usps = () => {
  return (
    <Container className="relative z-10 max-w-[800px] space-y-12 text-background-contrast-black py-36 text-xl leading-xl font-semibold sm:text-2xl sm:leading-2xl">
      {UspsData.map((Usp) => (
        <FadeIn key={Usp.id}>
          <h2>{Usp.content}</h2>
        </FadeIn>
