  ...
  return (
    ...
    >
      {enableVanish ? (
        <canvas
          className={cn(
            'absolute pointer-events-none text-sm transform scale-50 top-[20%] left-2 sm:left-8 origin-top-left filter invert dark:invert-0 pr-20',
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="dark:text-zinc-500 text-sm font-normal text-neutral-500 pl-10 text-left w-[calc(100%-2rem)] truncate"
            >
