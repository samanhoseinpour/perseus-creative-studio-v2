...
const BlogCta = () => {
  return (
    <section className="mb-16">
      <Container>
        <div className="relative overflow-hidden rounded-4xl border border-neutral-200 bg-neutral-950 px-5 py-8 text-white shadow-2xl shadow-neutral-950/10 sm:px-6 md:px-8 md:py-10">
          ...
          <div className="relative grid gap-6 lg:grid-cols-[1fr_320px] lg:items-end">
            <div>
              <Heading
                ...
                containerStyle="px-0 md:px-0 w-full max-w-none [&>div:first-child>span]:text-white/50 [&>div:first-child>span:nth-child(2)]:bg-white/20"
                titleStyle="max-w-4xl text-white [&_span]:text-white/30"
                descStyle="max-w-3xl text-neutral-300"
              />
            </div>

            <div className="rounded-3xl border border-white/10 bg-white/6 p-4 backdrop-blur md:p-5">
